...
public class ModBlockLootTableProvider extends BlockLootSubProvider {
    ...
    protected void generate() {
        ...
        dropSelf(ModBlocks.SOLAR_PYLON_BLOCK.get());
        ...
        this.add(ModBlocks.DEEPSLATE_SOLARIUM_ORE.get(),
                block -> createMultipleOreDrops(ModBlocks.DEEPSLATE_SOLARIUM_ORE.get(), ModItems.RAW_SOLARIUM_INGOT.get(), 3, 5));

        dropSelf(ModBlocks.SOLARIUM_STAIRS.get());
        this.add(ModBlocks.SOLARIUM_SLAB.get(),
                block -> createSlabItemTable(ModBlocks.SOLARIUM_SLAB.get()));
