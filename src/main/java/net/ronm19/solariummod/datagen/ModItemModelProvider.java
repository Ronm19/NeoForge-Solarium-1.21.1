...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        handheldItem(ModItems.SOLARIUM_DAGGER);

        trimmedArmorItem(ModItems.SOLARIUM_HELMET);
        trimmedArmorItem(ModItems.SOLARIUM_CHESTPLATE);
        trimmedArmorItem(ModItems.SOLARIUM_LEGGINGS);
        trimmedArmorItem(ModItems.SOLARIUM_BOOTS);
    ...
    private void trimmedArmorItem(DeferredItem<Item> itemDeferredItem) {
        final String MOD_ID = SolariumMod.MOD_ID; // Change this to your mod id
