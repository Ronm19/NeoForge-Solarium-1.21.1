...
public class SolariumPaxelItem extends DiggerItem {
    ...
    public SolariumPaxelItem(Tier tier, Properties properties) {
        super(tier, ModTags.Blocks.SOLARIUM_PAXEL_MINEABLE, properties);
    }
            ...
            if (optional1.isPresent()) {
                ...
                private Optional<BlockState> getStripped (BlockState unstrippedState){
                    return Optional.ofNullable((Block) STRIPPABLES.get(unstrippedState.getBlock()))
                            .map((p_150689_) -> (BlockState) p_150689_.defaultBlockState()
                                    .setValue(RotatedPillarBlock.AXIS, (Direction.Axis) unstrippedState.getValue(RotatedPillarBlock.AXIS)));
                }
