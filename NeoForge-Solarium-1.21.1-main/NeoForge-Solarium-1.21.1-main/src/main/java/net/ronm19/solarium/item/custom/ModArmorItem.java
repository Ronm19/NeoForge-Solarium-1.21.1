...
public class ModArmorItem extends ArmorItem {
    private static final Map<Holder<ArmorMaterial>, List<MobEffectInstance>> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<Holder<ArmorMaterial>, List<MobEffectInstance>>())
                    .put(ModArmorMaterials.SOLARIUM,
                            List.of(new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 300, 1, true, false),
                                    new MobEffectInstance(MobEffects.FIRE_RESISTANCE, 300, 1, true, false),
                                    new MobEffectInstance(MobEffects.DAMAGE_BOOST, 300, 0, true, false)))
                    .build();
